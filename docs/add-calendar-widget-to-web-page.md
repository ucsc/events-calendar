...
## Embed Widget Code in website

The best way to embed your widget code is as raw html.

### Embed in WordPress

Many UC Santa Cruz websites use the WordPress platform, which mainly uses block-based content editing. If you are embedding this code in a WordPress site, use the block editor to add the `Custom HTML` block to the area of your page where you want the Events Calendar widget to show.
